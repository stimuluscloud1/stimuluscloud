  ...
  <div class="container">
    <div class="row align-items-center">
      <div class="col-12 col-lg-5 col-xl-6 order-lg-2 mb-8 mb-lg-0">
        <!-- Image -->
        <img src="assets/images/hero/06.png" class="img-fluid" alt="...">
      </div>
      <div class="col-12 col-lg-7 col-xl-6 order-lg-1">
        <div class="owl-carousel no-pb" data-dots="false" data-items="1" data-margin="30" data-autoplay="true">
          <div class="item">
            <!-- Heading -->
...
<section>
  <div class="container">
    ...
    <!-- / .row -->
    <div class="row">
      <div class="col-12 col-lg-2 col-md-6 mb-8 mb-lg-0">
        <div class="text-center shadow hover-translate p-5">
          <div class="mb-3">
            <img class="img-fluid rounded-top" src="assets/images/technology/angular-js-logo.png" alt="">
          </div>
          <div>
            <h6 class="mb-1">Angular js</h6>
          </div>
        </div>
      </div>
      <div class="col-12 col-lg-2 col-md-6 mb-8 mb-lg-0">
        <div class="text-center shadow hover-translate p-5">
          <div class="mb-3">
            <img class="img-fluid rounded-top" src="assets/images/technology/react_logo.png" alt="" style="width: 70px;">
          </div>
          <div>
            <h6 class="mb-1">React js</h6>
          </div>
        </div>
      </div>
      <div class="col-12 col-lg-2 col-md-6 mb-8 mb-lg-0">
        <div class="text-center shadow hover-translate p-5">
          <div class="mb-3">
            <img class="img-fluid rounded-top" src="assets/images/technology/view.png" alt="">
          </div>
          <div>
            <h6 class="mb-1">Veu js</h6>
          </div>
        </div>
      </div>
      <div class="col-12 col-lg-2 col-md-6 mb-8 mb-lg-0">
        <div class="text-center shadow hover-translate p-5">
          <div class="mb-3">
            <img class="img-fluid rounded-top" src="assets/images/technology/node-icon.png" alt="">
          </div>
          <div>
      ...
      <div class="col-12 col-lg-2 col-md-6 mb-8 mb-md-0">
        <div class="text-center shadow hover-translate p-5">
          <div class="mb-3">
            <img class="img-fluid rounded-top" src="assets/images/technology/logo-applecc.png" alt="">
          </div>
          <div>
            <h6 class="mb-1">iOS</h6>
          </div>
        </div>
      </div>
      <div class="col-12 col-lg-2 col-md-6">
        <div class="text-center shadow hover-translate p-5">
          <div class="mb-3">
            <img class="img-fluid rounded-top" src="assets/images/technology/android.png" alt="">
          </div>
          <div>
    ...
    <div class="row">
      <div class="col-12 col-lg-2 col-md-6 mb-8 mb-lg-0">
        <div class="text-center shadow hover-translate p-5">
          <div class="mb-3">
            <img class="img-fluid rounded-top" src="assets/images/technology/php.png" alt="">
          </div>
          <div>
            <h6 class="mb-1">Core PHP</h6>
          </div>
        </div>
      </div>
      <div class="col-12 col-lg-2 col-md-6 mb-8 mb-lg-0">
        <div class="text-center shadow hover-translate p-5">
          <div class="mb-3">
            <img class="img-fluid rounded-top" src="assets/images/technology/ci-logo-white.png" style="width:42px" alt="">
          </div>
          <div>
            <h6 class="mb-1">CodeIgniter</h6>
          </div>
        </div>
      </div>
      <div class="col-12 col-lg-2 col-md-6 mb-8 mb-lg-0">
        <div class="text-center shadow hover-translate p-5">
          <div class="mb-3">
            <img class="img-fluid rounded-top" src="assets/images/technology/laravel.png" alt="">
          </div>
          <div>
      ...
      <div class="col-12 col-lg-2 col-md-6 mb-8 mb-lg-0">
        <div class="text-center shadow hover-translate p-5">
          <div class="mb-3">
            <img class="img-fluid rounded-top" src="assets/images/technology/wp.png" alt="">
          </div>
          <div>
      ...
      <div class="col-12 col-lg-2 col-md-6 mb-8 mb-md-0">
        <div class="text-center shadow hover-translate p-5">
          <div class="mb-3">
            <img class="img-fluid rounded-top" src="assets/images/technology/logo-api2.png" alt="">
          </div>
          <div>
      ...
      <div class="col-12 col-lg-2 col-md-6">
        <div class="text-center shadow hover-translate p-5">
          <div class="mb-3">
            <img class="img-fluid rounded-top" src="assets/images/technology/aws-1.png" alt="">
          </div>
          <div>
        ...
        <div class="row text-center">
          ...
          <div class="col-lg-6 col-md-6 mt-5">
            <div class="counter bg-white rounded p-5 shadow">
              <div class="counter-desc">
                <h5>Member</h5>
                <span class="count-number display-4 text-primary" data-to="69" data-speed="10000">69</span>
          ...
          <div class="col-lg-6 col-md-6 mt-5 mt-md-0">
            <div class="counter bg-white rounded p-5 shadow">
              <div class="counter-desc">
                <h5>Love Us</h5>
                <span class="count-number display-4 text-primary" data-to="45" data-speed="10000">45</span>
                <span class="display-4 text-primary">k</span> 
              </div>
            </div>
          </div>
