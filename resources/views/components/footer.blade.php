          ...
          <div class="row">
            <div class="col-12 col-sm-4 navbar-dark">
              ...
              <ul class="navbar-nav list-unstyled mb-0">
                <li class="mb-3 nav-item"><a class="nav-link" href="{{ 'about' }}">About</a>
                </li>
                </li>
                <li class="mb-3 nav-item"><a class="nav-link" href="{{ 'career' }}">Career</a>
                </li>
                <li class="mb-3 nav-item"><a class="nav-link" href="{{ 'our-portfolio' }}">Portfolio</a>
                </li>
                <li class="mb-3 nav-item"><a class="nav-link" href="{{ 'contact-us' }}">Contact Us</a>
                </li>
            ...
            <div class="col-12 col-sm-4 mt-6 mt-sm-0 navbar-dark">
              ...
              <ul class="navbar-nav list-unstyled mb-0">
                ...
                <li class="nav-item"><a class="nav-link" href="#">Content Writing</a>
                </li>
              </ul>
            </div>
            <div class="col-12 col-sm-4 mt-6 mt-sm-0 navbar-dark">
              ...
              <ul class="navbar-nav list-unstyled mb-0">
                ...
                <li class="mb-3 nav-item"><a class="nav-link" href="{{ 'privacy-policy' }}">Privacy Policy</a>
                </li>
          ...
          <div class="row mt-5">
            ...
            <div class="col-12 col-sm-6 mt-6 mt-sm-0">
              <ul class="list-inline mb-0">
                <li class="list-inline-item"><a class="text-light ic-2x" href="{{ url('https://www.facebook.com/Stimuluscloudservices') }}" target="_blank"><i class="la la-facebook"></i></a>
                </li>
                <li class="list-inline-item"><a class="text-light ic-2x" href="{{ url('https://dribbble.com/stimulus_cloud/about') }}" target="_blank"><i class="la la-dribbble"></i></a>
                </li>
                <li class="list-inline-item"><a class="text-light ic-2x" href="{{ url('https://www.instagram.com/stimulus_cloud/') }}" target="_blank"><i class="la la-instagram"></i></a>
                </li>
                <li class="list-inline-item"><a class="text-light ic-2x" href="{{ url('https://twitter.com/stimulus_cloud') }}" target="_blank"><i class="la la-twitter"></i></a>
                </li>
                <li class="list-inline-item"><a class="text-light ic-2x" href="{{ url('https://www.linkedin.com/company/stimuluscloud/') }}" target="_blank"><i class="la la-linkedin"></i></a>
                </li>
              </ul>
            </div>
          </div>
