    ...
    <div class="row align-items-center justify-content-between">
      ...
      <div class="col-12 col-lg-6 col-xl-5">
        <div class="mb-5"> <span class="h6 text-primary">
          ...
          <h2 class="mt-3 font-w-5">A Creative landing Page</h2>
          <p class="lead">We use the latest technologies it voluptatem accusantium doloremque.</p>
        </div>
        <div class="">
          <div class="mb-3">
            <div class="d-flex align-items-start">
              ...
              <p class="mb-0 ml-3">We use the latest technologies it voluptatem accusantium doloremqu</p>
            </div>
          </div>
          <div class="mb-3">
            <div class="d-flex align-items-start">
              ...
              <p class="mb-0 ml-3">Bootsland Landing Page Build With Static Bootstarp Code</p>
            </div>
          </div>
          <div>
            <div class="d-flex align-items-start">
              ...
              <p class="mb-0 ml-3">All types of businesses need access to development</p>
            </div>
          </div>
        </div>
      </div>      
